export enum TruthyError {
  ...
  Expo = `Always falsy`,
  Subtraction = `Always falsy`,
  ModUndefined = `Always falsy`,
  ModLeftNull = `Anything % null is falsy.`,
  ModBoolean = `Always falsy`,
  ModFunction = `Always falsy`,
  EqualityFunction = `Always falsy.`,
  ModRightNull = `null % anything is falsy.`,
  AdditionSymbol = `Any addition with a Symbol always throws.`,
  ExpoObjectLeft = `Anything ** {} is NaN.`,
  ModObjectLeft = `Anything % {} is falsy.`,
  ModObjectRight = `{} % anything is falsy.`,
